    ...
    return (
            ...
            <div className="container">
                ...
                <div className="stolby">
                    <svg
                        ...
                        enableBackground="new 0 0 511.411 407.229"
                        xmlSpace="preserve"
                    >
                        <g>
		...
		S351.489,8.312,351.489,8.312"/>
                        ...
                        <g>
                            ...
                            <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="39.7222" y1="269.0303"
                                            x2="6.912" y2="270.0892">
                                <stop offset="0" style={{stopColor: '#030500'}}/>
                                <stop offset="0.1656" style={{stopColor: '#030500'}}/>
                                <stop offset="0.4969" style={{stopColor: '#030500'}}/>
                                <stop offset="1" style={{stopColor: "#030500"}}/>
		...
		s-0.86-1.852-0.529-4.763C20.344,92.133,21.6,90.611,21.6,90.611"/>
                        ...
                        <g opacity="0.83">
                            ...
                            <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="177.9448" y1="343.2949"
                                            x2="162.7619" y2="343.7849">
                                <stop offset="0" style={{stopColor: '#030500'}}/>
                                <stop offset="0.1656" style={{stopColor: '#030500'}}/>
                                <stop offset="0.4969" style={{stopColor: '#030500'}}/>
                                <stop offset="1" style={{stopColor: "#030500"}}/>
		...
		C178.65,256.291,174.568,257.912,174.568,257.912z"/>
			...
			s-15.88,4.199-14.965,9.411C162.691,271.876,177.927,266.252,177.927,266.252z"/>
                            ...
                            <path fill="#030500" d="M169.559,260.729c0,0-7.7,2.681-8.755,5.234c-0.788,1.907,8.265-0.979,8.265-0.979
		...
		s-0.594-1.276-0.365-3.282C492.122,190.132,492.986,189.084,492.986,189.084"/>
                ...
                <div id="v1">
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                         x="0px" y="0px"
                         width="386.318px" height="383.263px" viewBox="0 0 386.318 383.263"
                         enableBackground="new 0 0 386.318 383.263"
                         xml:space="preserve">
<g>
	<g>
...
<g>
    ...
    <circle cx="193.021" cy="192.458" r="14.449"/>
            ...
            {/*<div className="sign">*/}
            {/*    <h1>Windmills</h1>*/}
            {/*    <p>Pure CSS object rotation</p>*/}
            {/*</div>*/}
        </>
    );
}

export default TurbineDemo;